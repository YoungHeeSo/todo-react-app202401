...
const TodoTemplate = () =>{
    ...
    const addTodo = (todoText) => {
        // console.log('할 일 등록 함수를 todoTemplate 에서 실행!!')
        ...
        */
        ...
        const copyTodoList = [...todoList, newTodo];
    ...
    const removeTodo = id =>{
        ...
        setTodoList(todoList.filter(todo => todo.id !== id)); // todoList 에서 id가 다른 애들만 남겨놔
        // filter 나 map 은 복사된 배열 값을 반환 한다
    }
